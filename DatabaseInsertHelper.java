...
public class DatabaseInsertHelper {
   ...
   */
  public static int insertRole(String name, Context context) throws DatabaseInsertException, InvalidRoleException, SQLException,
   ...
   * @throws SQLException if something goes wrong.
   */
  public static int insertNewUser(String name, int age, String address, String password, Context context) throws
   ...
   */
  public static int insertUserRole(int userId, int roleId,Context context) throws DatabaseInsertException, SQLException,
  ...
  public static int insertItem(String name, BigDecimal price, Context context) throws DatabaseInsertException,
    ...
    int itemId = -1;
    try{
        itemId = (int) db.insertItem(name, price);
    }catch (Exception e){
   ...
   * @throws SQLException if something goes wrong.
   */
  public static int insertInventory(int itemId, int quantity, Context context) throws DatabaseInsertException,
   ...
   * @throws SQLException if something goes wrong.
   */
  public static int insertSale(int userId, BigDecimal totalPrice, Context context) throws DatabaseInsertException,
   ...
   */
  public static int insertItemizedSale(int saleId, int itemId, int quantity, Context context) throws DatabaseInsertException,
  ...
  public static int insertAccount(int userId, boolean active, Context context) throws SQLException, DatabaseInsertException {
      int accountId = -1;
      DatabaseDriverAndroid db = new DatabaseDriverAndroid(context);
      try {
  ...
  public static int insertAccountLine(int accountId, int itemId, int quantity, Context context) throws DatabaseInsertException,
      SQLException {
      int id = -1;
      DatabaseDriverAndroid db = new DatabaseDriverAndroid(context);
      try{
